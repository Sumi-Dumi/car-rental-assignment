/*
  ...
  - You are about to drop the column `driversLicenseNumber` on the `Order` table. All the data in the column will be lost.
  ...
  - Added the required column `licenseNumber` to the `Order` table without a default value. This is not possible if the table is not empty.
